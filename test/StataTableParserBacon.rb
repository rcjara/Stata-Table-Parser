...
require_relative '../lib/StataTableParser.rb'
require_relative 'StataTableParserHelper.rb'
...
#    end
  ...
  describe "a divided table" do
    before do
      @parser = StataTableParser.new(File.dirname(__FILE__) + "/../TestTables/DividedTable.txt")
    end

    it "should find the right number of tables" do
      @parser.num_tables.should == 1
    end

    it "should have the right number of columns" do
      @parser.first_table.num_cols.should == 6
    end

    it "should have the right number of rows" do
      @parser.first_table.num_rows.should == 14
    end
  end
