require File.dirname( File.expand_path(__FILE__)) + '/TableSegment.rb'
require File.dirname( File.expand_path(__FILE__)) + '/TabSegment.rb'
require File.dirname( File.expand_path(__FILE__)) + '/NumDecoder.rb'
